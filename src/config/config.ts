    ...
    buttons: {
        ...
        accountButtons: {
            ...
            anonymous: {
                ...
                // eslint-disable-next-line max-len
                img: `
                 <path d="m6.5 11h-2c-.27614 0-.5.2239-.5.5s.22386.5.5.5h15c.2761 0
                  .5-.2239.5-.5s-.2239-.5-.5-.5h-2c0-3.03757-2.4624-5.5-5.5-5.5-3.03757
                   0-5.5 2.46243-5.5 5.5zm1 0c0-2.48528
                    2.01472-4.5 4.5-4.5 2.4853 0 4.5 2.01472 4.5 4.5z" 
                 />
                 <path d="m10.437 15c-.222-.8626-1.00508-1.5-1.937-1.5-1.10457 0-2 
                 .8954-2 2s.89543 2 2 2c.93192 0 1.715-.6374 1.937-1.5h3.126c.222.8626 
                 1.0051 1.5 1.937 1.5 1.1046 0 2-.8954 2-2s-.8954-2-2-2c-.9319 
                 0-1.715.6374-1.937 1.5zm-1.937-.5c-.55228 0-1 .4477-1 1s.44772 
                 1 1 1 1-.4477 1-1-.44772-1-1-1zm6 1c0 .5523.4477 1 1 1s1-.4477 
                 1-1-.4477-1-1-1-1 .4477-1 1z"/>
                 `,
            },
            logout: {
                href: '/logout',
        ...
        mailFormatterButtons: {
            bold: {
                href: '/bold',
                img: `<path style="transform: scale(1.25);" clip-rule="evenodd" 
            ...
            cursive: {
                href: '/cursive',
                img: `<path fill-rule="evenodd" style="transform: scale(1.25);"
            ...
            strike: {
                href: '/strike',
                img: `<path clip-rule="evenodd" style="transform: scale(1.25);" d="M5.443 6.49143l1.853-4.054c.129-.283.413-.447.705-.437.293-.009.576.154.705.437l1.852 4.054h2.69c.415 0 .752.337.752.752s-.337.752-.752.752h-2.003l2.027 4.436c.171.376.006.821-.37.992-.376.172-.821.007-.993-.369l-.94-2.058H5.03l-.94 2.058c-.172.376-.617.541-.993.369-.376-.171-.541-.616-.369-.992l2.028-4.436H2.752c-.415 0-.752-.337-.752-.752s.337-.752.752-.752h2.691zm.959 1.504l-.687 1.503h4.57l-.687-1.503H6.402zm.688-1.504h1.821l-.91-1.993-.911 1.993z" 
                fill-rule="evenodd"/>`,
                text: 'Зачеркнутый шрифт',
            },
            subscript: {
                href: '/subscript',
                img: `<path style="transform: scale(0.8);" d="M19,3V5a1,1,0,0,1-2,0V4H12V16h2a1,1,0,0,1,0,2H8a1,1,0,0,1,0-2h2V4H5V5A1,1,0,0,1,3,5V3A1,1,0,0,1,4,2H18A1,1,0,0,1,19,3Zm1.555,14.832A1,1,0,0,0,21,17V15a1,1,0,0,0-1-1H17a1,1,0,0,0,0,2h2v.465l-2.555,1.7A1,1,0,0,0,16,19v2a1,1,0,0,0,1,1h3a1,1,0,0,0,0-2H18v-.465Z"/>`,
                text: 'Верхний регистр',
            },
            superscript: {
                href: '/superscript',
                img: `<path style="transform: scale(0.8);" d="M1,10V8A1,1,0,0,1,2,7H16a1,1,0,0,1,1,1v2a1,1,0,0,1-2,0V9H10V21h2a1,1,0,0,1,0,2H6a1,1,0,0,1,0-2H8V9H3v1a1,1,0,0,1-2,0ZM22,1H19a1,1,0,0,0,0,2h2v.465l-2.555,1.7A1,1,0,0,0,18,6V8a1,1,0,0,0,1,1h3a1,1,0,0,0,0-2H20V6.535l2.555-1.7A1,1,0,0,0,23,4V2A1,1,0,0,0,22,1Z"/>`,
                text: 'Нижний регистр',
            },
            justifyLeft: {
                href: '/justifyLeft',
                img: `<path clip-rule="evenodd" style="transform: scale(1.25);" d="M11.502 13c.275 0 .498.223.498.498 0 .274-.223.498-.498.498H2.498c-.275 0-.498-.224-.498-.498 0-.275.223-.498.498-.498h9.004zm-4-2c.275 0 .498.223.498.498 0 .276-.223.499-.498.499H2.498c-.275 0-.498-.223-.498-.499 0-.275.223-.498.498-.498h5.004zm1.996-2c.277 0 .502.225.502.502s-.225.502-.502.502H2.502c-.277 0-.502-.225-.502-.502S2.225 9 2.502 9h6.996zm2.004-2c.275 0 .498.223.498.498 0 .274-.223.498-.498.498H2.498c-.275 0-.498-.224-.498-.498C2 7.223 2.223 7 2.498 7h9.004zM9.498 5c.277 0 .502.225.502.502s-.225.502-.502.502H2.502c-.277 0-.502-.225-.502-.502S2.225 5 2.502 5h6.996zm3.997-2c.279 0 .505.226.505.505s-.226.506-.505.506H2.505c-.279 0-.505-.227-.505-.506S2.226 3 2.505 3h10.99z" 
                fill-rule="evenodd"/>`,
                text: 'Выравнивание слева',
            },
            justifyRight: {
                href: '/justifyRight',
                img: `<path clip-rule="evenodd" style="transform: scale(1.25);"
            ...
            undo: {
                href: '/undo',
                img: `<path clip-rule="evenodd" style="transform: scale(1.25);" d="M8.16 14H5.463c-.443 0-.803-.36-.803-.803 0-.444.36-.803.803-.803h2.689c2.149 0 3.894-1.245 3.894-3.394S10.309 5.607 8.16 5.606h-1.5v1.795c0 .331-.26.599-.581.599-.121 0-.234-.038-.327-.104L2.288 5.518c-.02-.012-.038-.025-.056-.039C2.091 5.37 2 5.196 2 5.001c0-.194.089-.366.227-.476h.001c.02-.016.041-.031.064-.044l3.447-2.368c.096-.071.213-.113.34-.113.321 0 .581.268.581.599V4h1.508c3.035 0 5.492 1.964 5.492 5 0 3.035-2.464 5-5.5 5z" 
                fill-rule="evenodd"/>`,
                text: 'Отменить',
            },
            redo: {
            ...
            removeFormat: {
                href: '/removeFormat',
                img: `<path fill-rule="evenodd" style="transform: scale(1.25);" clip-rule="evenodd" d="M5.15786 7.67063L2.95349 9.875 6.07849 13h.09314l2.1578-2.1578-3.17157-3.17157zm1.41421-1.41421l3.17158 3.17157L13.0466 6.125 9.87506 2.95343 6.57207 6.25642zM4.71085 14.4608c.50063.5006 1.20065.6804 1.84445.5392H13c.5523 0 1-.4477 1-1s-.4477-1-1-1H9.00006l5.46074-5.46078c.7811-.78105.7811-2.04738 0-2.82843l-3.1715-3.17157c-.7811-.78105-2.0474-.78105-2.82845 0L1.53928 8.46079c-.78105.78105-.78105 2.04741 0 2.82841l3.17157 3.1716z"></path>`,
                text: 'Очистить',
            },
        },
        filterButtons: {
    ...
    forms: {
        login: {
            ...
            promoBox: {
                ...
                fields: {
                    first: {
                        text: 'Ищите и фильтруйте письма в соответствии с заданными параметрами',
                    ...
                    second: {
                        text: 'Создайте анонимный ящик для контроля спама',
                    ...
                    third: {
                        text: 'Редактируйте стиль писем как вы пожелаете',
